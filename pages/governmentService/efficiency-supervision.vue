		...
		<div class="main">
			...
			<div id="firstTab" class="section-item">
				<div class="title">
					...
					<span class="title-text">整体概况</span>
				</div>
			...
			<div id="secondTab" class="section-item">
				<div class="title">
					<span class="title-icon-bar-left"></span>
					<span class="title-icon-bar-right"></span>
					<span class="title-text">申请类型</span>
				</div>
				<div class="content-landing">
					<div class="tab-box-one-line">
						<div class="first-title-box first" style='width:30%'>
							...
							<div class="label">窗口办理</div>
							<div class="num">876624<span class="char">件</span></div>
						</div>
						<div class="first-title-box second" style='width:28%'>
							<div class="firstLine">
								<span class='secondPic'></span>
							</div>
							<div class="label">网上办理</div>
							<div class="num">23961<span class="char">件</span></div>
						</div>
						<div class="first-title-box second" style='width:28%'>
							<div class="firstLine">
								<span class='secondPic'></span>
							</div>
							<div class="label">邮寄办理</div>
							<div class="num">3<span class="char">件</span></div>
						</div>
					</div>
