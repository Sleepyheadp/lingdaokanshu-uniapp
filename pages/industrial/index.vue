...
<script>
  ...
  // 表格 + label
  // import efficiencySupervision from "./efficiency-supervision";
  // 带图表
  import agricultureInf from './agricultureG'
  // import businessScoreGover from './business-score-gover.vue'
  // import industryGover from "./industry-gover.vue"

  export default {
    name: "index",
    components: {agricultureInf},
    data() {
      return {
        isLoading: true,
        hasSecondTab: false,
        ...
        subTabList: ["主体活力","主体分布","主体资质","企业创新","企业监管"],
        tabData: {},
        projectData: {},
        subIndexOffset: [],
		testData2:
