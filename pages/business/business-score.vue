      ...
      <div class="content-score-chart">
        <div class="tab-box-one-tab">
          <div class="tab-img-box">
            ...
            <img src="data:image/png;base64," alt="">
          </div>
          <div class="tab-content-box">
            <span>包头市{{ this.tabData.detail.year }}年营商环境综合得分为{{ this.tabData.detail.score }}分,在粤港澳大湾区中排名第{{ this.tabData.detail.rank }}名</span>
          </div>
        </div>
      ...
      <div class="content-score-list">
        ...
        <div class="score-result">
          <ul class="list-header">
            <li v-for="(item,index) in this.tabData.listheader">
              {{ item }}
              <div v-if="index !==3" class="splitLine"></div>
            </li>
          </ul>
          <ul class="score-list">
            <li v-for="(data_item,index_1) in this.tabData.list" :key="index_1" class="li-style">
...
<script>
    ...
    export default {
      ...
      watch: {
        'tabData.chart': function (newValue, oldValue) {
          this.initWin();
        }
      },
      methods: {
        initWin() {
          this.$nextTick(() => {
            this.tabData.chart.gridBottom = 100;
            this.tabData.chart.gridTop = 60;
            barChartForBusiness('rateBarMap', this.tabData.chart);
          })
        },
        // 打开、关闭列表
        openAndClose(i){
